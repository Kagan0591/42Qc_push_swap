...
ARGS=`ruby -e "puts (10..108).to_a.shuffle.join(' ')"`; echo "100 arg randomized including one INT MIN: "$(./push_swap -2147483648 $ARGS | wc -l) $(./push_swap -2147483648 $ARGS | ./checker_$OS $ARGS)
...
echo""
echo""
ARGS=`ruby -e "puts (10..108).to_a.shuffle.join(' ')"`; echo "100 arg randomized including one INT MIN: "$(./push_swap -2147483648 $ARGS) $(./push_swap $ARGS | ./checker_$OS $ARGS)
ARGS=`ruby -e "puts (10..108).to_a.shuffle.join(' ')"`; echo "100 arg randomized including one INT MAX: "$(./push_swap 2147483647 $ARGS) $(./push_swap $ARGS | ./checker_$OS $ARGS)
ARGS=`ruby -e "puts (10..109).to_a.shuffle.join(' ')"`; echo "100 arg randomized: "$(./push_swap $ARGS) $(./push_swap $ARGS | ./checker_$OS $ARGS)
ARGS=`ruby -e "puts (-108..-10).to_a.shuffle.join(' ')"`; echo "100 arg randomized: "$(./push_swap $ARGS) $(./push_swap $ARGS | ./checker_$OS $ARGS)
ARGS=`ruby -e "puts (10..109).to_a.shuffle.join(' ')"`; echo "100 arg randomized: "$(./push_swap $ARGS) $(./push_swap $ARGS | ./checker_$OS $ARGS)
ARGS=`ruby -e "puts (10..109).to_a.shuffle.join(' ')"`; echo "100 arg randomized: "$(./push_swap $ARGS) $(./push_swap $ARGS | ./checker_$OS $ARGS)
ARGS=`ruby -e "puts (-108..-10).to_a.shuffle.join(' ')"`; echo "100 arg randomized: "$(./push_swap $ARGS) $(./push_swap $ARGS | ./checker_$OS $ARGS)
ARGS=`ruby -e "puts (10..109).to_a.shuffle.join(' ')"`; echo "100 arg randomized: "$(./push_swap $ARGS) $(./push_swap $ARGS | ./checker_$OS $ARGS)
